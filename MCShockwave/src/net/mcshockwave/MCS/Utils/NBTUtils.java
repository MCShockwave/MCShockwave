...
public class NBTUtils {   
     ...
     * See also:
     * <ul>
     *   <li>{@link NBTUtils#createCompound()}</li>
     *   <li>{@link NBTUtils#fromCompound(Object)}</li>
     * </ul>
     * @author Kristian
     */
     ...
     * See also:
     * <ul>
     *   <li>{@link NBTUtils#createNbtList()}</li>
     *   <li>{@link NBTUtils#fromList(Object)}</li>
     * </ul>
     * @author Kristian
     */
    ...
    private NBTUtils() {
        if (BASE_CLASS == null) {
            try {
                ...
                ClassLoader loader = NBTUtils.class.getClassLoader();
