...
public class DataCommand implements Listener, CommandExecutor {
	...
	public ItemMenu getDataMenu(Player p) {
		...
		Button bbStats = new Button(false, Material.NETHER_STAR, 1, 0, "Stats - §kBattle Bane", new String[] { "",
				"Kills: §e" + bbKills, "Deaths: §e" + bbDeaths, "K/D Ratio: §e" + bbKD, "", "Wins: §e" + winsBB });
